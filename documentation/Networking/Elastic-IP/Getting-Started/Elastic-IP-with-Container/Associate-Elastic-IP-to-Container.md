# Elastic IP Associates Container Instance
...
Step 5: In the Associate Resource popup, select Container Instance Resource to which the Elastic IP will be associated.
